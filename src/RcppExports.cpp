...
RcppExport SEXP _FAST_iSCMEBCpp(SEXP vListSEXP, SEXP AdjlistSEXP, SEXP yList_intSEXP, SEXP Mu_intSEXP, SEXP Sigma_intSEXP, SEXP Psi_intSEXP, SEXP beta_intSEXP, SEXP beta_gridSEXP, SEXP maxIter_ICMSEXP, SEXP maxIterSEXP, SEXP epsLogLikSEXP, SEXP verboseSEXP, SEXP homoSEXP, SEXP Sigma_equalSEXP, SEXP Sigma_diagSEXP, SEXP Sp_embedSEXP, SEXP maxKSEXP, SEXP minKSEXP, SEXP coreNumSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _FAST_getneighborhood_fast(SEXP xSEXP, SEXP radiusSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _FAST_wpcaCpp(SEXP XSEXP, SEXP nPCsSEXP, SEXP weightedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type X(XSEXP);
...
RcppExport SEXP _FAST_correct_one_gene(SEXP XlistSEXP, SEXP RListSEXP, SEXP HListSEXP, SEXP TmSEXP, SEXP AdjlistSEXP, SEXP sigmaj_intSEXP, SEXP psij_intSEXP, SEXP alphaj_intSEXP, SEXP gammaj_intSEXP, SEXP zetaj_intSEXP, SEXP maxIterSEXP, SEXP epsELBOSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _FAST_correct_genes(SEXP XListSEXP, SEXP RListSEXP, SEXP HListSEXP, SEXP TmSEXP, SEXP AdjlistSEXP, SEXP sigma_intSEXP, SEXP psi_intSEXP, SEXP alpha_intSEXP, SEXP gamma_intSEXP, SEXP zeta_intSEXP, SEXP maxIterSEXP, SEXP epsELBOSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type XList(XListSEXP);
...
RcppExport SEXP _FAST_profast_g_cpp(SEXP XlistSEXP, SEXP AdjlistSEXP, SEXP nu_intSEXP, SEXP W_intSEXP, SEXP Lam_intSEXP, SEXP Psi_intSEXP, SEXP EvListSEXP, SEXP maxIterSEXP, SEXP epsLogLikSEXP, SEXP verboseSEXP, SEXP homoSEXP, SEXP Psi_diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type Xlist(XlistSEXP);
...
RcppExport SEXP _FAST_profast_p_cpp(SEXP XlistSEXP, SEXP AListSEXP, SEXP AdjlistSEXP, SEXP nv_intSEXP, SEXP W_intSEXP, SEXP Lam_intSEXP, SEXP Psi_intSEXP, SEXP EvListSEXP, SEXP maxIterSEXP, SEXP epsELBOSEXP, SEXP verboseSEXP, SEXP homoSEXP, SEXP Psi_diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type Xlist(XlistSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_FAST_iSCMEBCpp", (DL_FUNC) &_FAST_iSCMEBCpp, 19},
    {"_FAST_getneighborhood_fast", (DL_FUNC) &_FAST_getneighborhood_fast, 2},
    {"_FAST_wpcaCpp", (DL_FUNC) &_FAST_wpcaCpp, 3},
    {"_FAST_correct_one_gene", (DL_FUNC) &_FAST_correct_one_gene, 13},
    {"_FAST_correct_genes", (DL_FUNC) &_FAST_correct_genes, 13},
    {"_FAST_profast_g_cpp", (DL_FUNC) &_FAST_profast_g_cpp, 12},
    {"_FAST_profast_p_cpp", (DL_FUNC) &_FAST_profast_p_cpp, 13},
    {NULL, NULL, 0}
};
